...
def load_dataset():
    classes = [0, 1]
    # load dataset
    trainX, trainY, testX, testY = dataset.read_train_sets2("/home/espenm/data/scenes/train_data.txt",
                                                                "/home/espenm/data/scenes/", 
                                                                128, classes, validation_size=validation_split)
    # one hot encode target values
    trainY = to_categorical(trainY, 2, dtype='float32')
    testY = to_categorical(testY, 2, dtype='float32')
